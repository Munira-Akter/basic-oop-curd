...
<body>
    ...
    if (isset($_POST['teacheradd'])) {
        ...
        $filetmp_name = $_FILES['profile']['tmp_name'];

        $photo = md5(time() . rand()) . $filename;
        move_uploaded_file($filetmp_name , 'photo/' . $photo);
        ...
        if (empty($name) || empty($email) || empty($cell) || empty($uname)) {
            ...
            $msg = $teach -> teacher_data_insert($name , $email , $cell , $uname , $date , $gender , $pass, $photo);
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <br><br><br>
                                    <div class="form-group">
                                        <input class="btn btn-dark" type="submit" value="Sign In" name="teacheradd">
                                    </div>
                                </form>
                            </div>
                        </div>
