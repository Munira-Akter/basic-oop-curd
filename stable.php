                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $all_data['date']?></td>
                            <td><?php echo $all_data['gender']?></td>
                            <td><img src="photo/<?php echo $all_data['photo']?>" alt=""></td>
                            
                            <td>
                                <a class="btn btn-sm btn-info" href="profile.php?profile_id=<?php echo $all_data['id']?>">View</a>
                                <a class="btn btn-sm btn-warning" href="sttafedit.php?sedit_id=<?php echo $all_data['id']?>">Edit</a>
